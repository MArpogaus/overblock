...
commit, the commit message through commitizen, and package-lint, the
compilation and the tests before a push.  Indent and checkdoc come
...
treats any output at all as a failure:
