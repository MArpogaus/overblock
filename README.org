...
display and measures the scrolling.  =make format= indents every Lisp
file, which is =tools/indent.el= and nothing more than the indentation
=indent-region= gives Lisp: no form is rewritten and no line reflowed.
