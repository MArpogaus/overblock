...
| Option                     | Default                        | Meaning                                 |
|----------------------------+--------------------------------+-----------------------------------------|
| =overblock-pydoc-markup=   | =rst=                          | the markup the doc strings are written in |
...
reStructuredText is the default, because
that is what Python's own tools read.  A project whose doc strings are
Markdown says so once, per project:
