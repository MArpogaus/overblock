...
needs a display and measures the scrolling.  =make test-live= runs a
small suite against a real IPython, and skips with a word where none is
installed.  =make format= indents
